...
```
<div align="center">
<img src="img/scale.png" alt="proceso de escalado" width="800" style="border-radius: 10px; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);">
<p><em>Evidencia del proceso de scale .</em></p>
</div>

Verificamos si se hicieron las replicas:

<div align="center">
<img src="img/ls-scaled.png" alt="Imagen subida a Docker Hub" width="800" style="border-radius: 10px; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);">
<p><em>Evidencia de la lista del servicio con el cambio de replicas.</em></p>
</div>
